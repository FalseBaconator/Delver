...
namespace TextRPG
{
    internal class Kobold : Enemy
    {
        ...
        public Kobold(Position pos, Map map, Player player, EnemyManager enemyManager, ItemManager itemManager, Render rend, GameManager gameManager, Hud hud, Exit exit, SoundManager soundManager) : base(pos, Constants.koboldBaseHP, Constants.koboldBaseAttack, Constants.koboldSprite, Constants.koboldName, map, player, enemyManager, itemManager, rend, gameManager, hud, exit, Constants.koboldXP, Constants.koboldGold, soundManager)
        {
